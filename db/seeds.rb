...
category2s = [
  ...
  { level2: "パンツ", level2_children: ["デニム/ジーンズ", "ショートパンツ", "カジュアルパンツ", "ハーフパンツ", "チノパン",
                                        ...
                                        "ガウチョパンツ", "その他"] },
  { level2: "スカート", level2_children: %w[ミニスカート ひざ丈スカート ロングスカート キュロット その他] },
  { level2: "ワンピース", level2_children: %w[ミニワンピース ひざ丈ワンピース ロングワンピース その他] },
  { level2: "靴", level2_children: ["ハイヒール/パンプス", "ブーツ", "サンダル", "スニーカー", "ミュール", "モカシン",
                                    "ローファー／革靴", "フラットシューズ/バレエシューズ", "長靴/レインシューズ", "その他"] },
  { level2: "ルームウェア/パジャマ", level2_children: %w[パジャマ ルームウェア] },
  ...
  { level2: "時計", level2_children: ["腕時計(アナログ)", "腕時計(デジタル)", "ラバーベルト", "レザーベルト", "金属ベルト",
                                      "その他"] },
  { level2: "ウィッグ/エクステ", level2_children: %w[前髪ウィッグ ロングストレート ロングカール ショートストレート
                                                     ショートカール その他] },
  { level2: "浴衣/水着", level2_children: ["浴衣", "着物", "振袖", "長襦袢/半襦袢", "水着セパレート", "水着ワンピース",
                                           "水着スポーツ用", "その他"] },
  { level2: "スーツ/フォーマル/ドレス", level2_children: %w[スカートスーツ上下 パンツスーツ上下 ドレス パーティーバッグ
                                                            シューズ ウェディング その他] },
  { level2: "マタニティ", level2_children: ["トップス", "アウター", "インナー", "ワンピース", "パンツ/スパッツ", "スカート",
                                            "パジャマ", "授乳服", "その他"] },
  { level2: "その他", level2_children: %w[コスプレ 下着 その他] }
]

category2s.each.with_index(1) do |category2, i|
  level2_var = "@category2_#{i}"
  level2_val = @category2.children.create(name: (category2[:level2]).to_s)
  eval("#{level2_var} = level2_val")
  category2[:level2_children].each do |_level2_children_val|
...
category3s = [
  ...
  { level2: "バッグ", level2_children: ["ショルダーバッグ", "トートバッグ", "リュック/バックパック", "ボストンバッグ",
                                        ...
                                        "エコバッグ", "その他"] },
  { level2: "スーツ", level2_children: %w[スーツジャケット スーツベスト スラックス セットアップ その他] },
  ...
  { level2: "時計", level2_children: ["腕時計(アナログ)", "腕時計(デジタル)", "ラバーベルト", "レザーベルト", "金属ベルト",
                                      "その他"] },
  { level2: "水着", level2_children: %w[一般水着 スポーツ用 アクセサリー その他] },
  { level2: "レッグウェア", level2_children: ["ソックス", "レギンス/スパッツ", "レッグウォーマー", "その他"] },
  { level2: "アンダーウェア", level2_children: %w[トランクス ボクサーパンツ その他] },
  { level2: "その他", level2_children: %w[コスプレ 下着 その他] }
]
category3s.each.with_index(1) do |category3, i|
  level2_var = "@category3_#{i}"
  level2_val = @category3.children.create(name: (category3[:level2]).to_s)
  eval("#{level2_var} = level2_val")
  category3[:level2_children].each do |_level2_children_val|
    eval("#{level2_var}.children.create(name:level2_children_val)")
  end
end
...
category4s = [
  ...
  { level2: "キッズ靴", level2_children: %w[スニーカー サンダル ブーツ 長靴 その他] },
  ...
  { level2: "外出/移動用品", level2_children: ["ベビーカー", "抱っこひも/スリング",
                                               "チャイルドシート", "その他"] },
  { level2: "授乳/食事", level2_children: %w[ミルク ベビーフード ベビー用食器 その他] },
  ...
  { level2: "行事/記念品", level2_children: ["お宮参り用品", "お食い初め用品", "アルバム",
                                             "手形/足形", "その他"] },
  { level2: "その他", level2_children: %w[母子手帳用品 その他] }
]
category4s.each.with_index(1) do |category4, i|
  level2_var = "@category4_#{i}"
  level2_val = @category4.children.create(name: (category4[:level2]).to_s)
  eval("#{level2_var} = level2_val")
  category4[:level2_children].each do |_level2_children_val|
    eval("#{level2_var}.children.create(name:level2_children_val)")
  end
end
...
category5s = [
  ...
  { level2: "椅子/チェア", level2_children: %w[一般 スツール ダイニングチェア
  ...
  { level2: "カーテン/ブラインド", level2_children: %w[カーテン ブラインド ロールスクリーン
                                                       のれん その他] },
...
category5s.each.with_index(1) do |category5, i|
  ...
  level2_val = @category5.children.create(name: (category5[:level2]).to_s)
  eval("#{level2_var} = level2_val")
  category5[:level2_children].each do |_level2_children_val|
    eval("#{level2_var}.children.create(name:level2_children_val)")
  end
end
...
category6s = [
  ...
  { level2: "漫画", level2_children: %w[全巻セット 少年 少女 青年 女性 同人誌 その他] },
  ...
  { level2: "レコード", level2_children: %w[邦楽 洋楽 その他] },
  { level2: "テレビゲーム", level2_children: %w[家庭用ゲーム本体 家庭用ゲームソフト
                                                携帯用ゲーム本体 携帯用ゲームソフト PCゲーム その他] }
]

category6s.each.with_index(1) do |category6, i|
  level2_var = "@category6_#{i}"
  level2_val = @category6.children.create(name: (category6[:level2]).to_s)
  eval("#{level2_var} = level2_val")
  category6[:level2_children].each do |_level2_children_val|
    eval("#{level2_var}.children.create(name:level2_children_val)")
  end
end
