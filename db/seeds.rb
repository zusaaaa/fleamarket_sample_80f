...
category3s = [
              ...
              { level2: "バッグ", level2_children: ["ショルダーバッグ", "トートバッグ", "リュック/バックパック", "ボストンバッグ", "ウエストポーチ", "ボディーバッグ", "ドラムバッグ", "ビジネスバッグ", "トラベルバッグ", "メッセンジャーバッグ", "エコバッグ", "その他"] },
...
category5s = [
              ...
              { level2: "ソファ/ソファベッド", level2_children: ["ソファセット", "シングルソファ", "ラブソファ", "トリプルソファ", "オットマン", "コーナーソファ", "ビーンズソファ/クッションソファ", "ローソファ/フロアソファ", "ソファベッド", "応援セット", "ソファカバー", "リクライニングソファ", "その他"] },
              ...
              { level2: "インテリア/小物", level2_children: ["クッションカバー", "スリッパラック", "ティッシュボックス", "バスケット/かご", "フォトフレーム", "マガジンラック", "モビール", "花瓶", "灰皿", "傘立て", "小物入れ", "置時計", "掛時計/柱時計", "鏡", "置物", "風鈴", "植物/観葉植物", "その他"] },
              { level2: "季節/年中行事", level2_children: ["正月", "成人式", "バレンタインデー", "ひな祭り", "こどもの日", "母の日", "父の日", "サマーギフト/お中元", "夏/夏休み", "ハロウィン", "敬老の日", "七五三", "お歳暮", "クリスマス", "冬一般", "その他"] },
              { level2: "その他", level2_children: ["キッチン/食器", "ベッド/マットレス", "ソファ/ソファベッド", "椅子", "机", "収納家具", "ラグ/カーペット/マット", "カーテン/ブラインド", "照明", "寝具", "インテリア小物", "季節/年中行事", "その他"] }
            ]
...
category6s = [
              { level2: "本", level2_children: ["文学/小説", "人文/社会", "ノンフィクション/教養", "地図/旅行/ガイド", "ビジネス/経済", "健康/医学", "コンピュータ/IT", "趣味/スポーツ/実用", "住まい/暮らし/子育て", "アート/エンタメ", "洋書", "絵本", "参考書", "その他"] },
              { level2: "漫画", level2_children: %w[全巻セット 少年 少女 青年 女性 同人誌 その他] },
              { level2: "雑誌", level2_children: ["アート/エンタメ/ホビー", "ファッション", "ニュース/総合", "趣味/スポーツ", "その他"] },
              { level2: "CD", level2_children: ["外国映画", "日本映画", "アニメ", "TVドラマ", "ミュージック", "お笑い/バラエティ", "スポーツ/フィットネス", "キッズ/ファミリー", "その他"] },
